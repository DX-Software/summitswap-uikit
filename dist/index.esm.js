import React, { useMemo, isValidElement, cloneElement, Children, useEffect, useRef, useState, useCallback, useReducer, createContext, useContext } from 'react';
...
import { ResponsiveContainer, BarChart, XAxis, YAxis, Tooltip as Tooltip$1, Bar as Bar$1, AreaChart, Area } from 'recharts';
...
var Percent = function (_a) {
    ...
    if (!value || Number.isNaN(value)) {
        return React.createElement(Text, __assign({}, rest), "-");
    }
    var isNegative = useMemo(function () { return value < 0; }, [value]);
    return (React.createElement(Text, __assign({}, rest, { color: isNegative ? "failure" : "success" }),
        isNegative ? "↓" : "↑",
...
var Icon$4 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 14 14" }, props),
        React.createElement("path", { d: "M13 8L8 8V13C8 13.55 7.55 14 7 14C6.45 14 6 13.55 6 13V8L1 8C0.45 8 0 7.55 0 7C0 6.45 0.45 6 1 6L6 6V1C6 0.45 6.45 0 7 0C7.55 0 8 0.45 8 1V6L13 6C13.55 6 14 6.45 14 7C14 7.55 13.55 8 13 8Z" })));
};
...
var Icon$n = function (props) {
    var theme = useTheme();
    var color = props.color ? props.color : "primary";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 66 66", fill: "none" }, props),
        React.createElement("path", { d: "M33 5.5C17.8365 5.5 5.5 17.8365 5.5 33C5.5 48.1635 17.8365 60.5 33 60.5C48.1635 60.5 60.5 48.1635 60.5 33C60.5 17.8365 48.1635 5.5 33 5.5ZM33 55C20.8698 55 11 45.1302 11 33C11 20.8698 20.8698 11 33 11C45.1302 11 55 20.8698 55 33C55 45.1302 45.1302 55 33 55Z", fill: theme.colors[color] }),
        React.createElement("path", { d: "M35.75 19.25H30.25V34.1385L39.3058 43.1943L43.1942 39.3057L35.75 31.8615V19.25Z", fill: theme.colors[color] })));
};
...
var Icon$q = function (props) {
    var theme = useTheme();
    var color = props.color ? props.color : "primary";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 35 23", fill: "none" }, props),
        React.createElement("path", { d: "M17.4998 0.25C9.00942 0.25 0.416504 2.89108 0.416504 7.9375V14.7708C0.416504 19.8173 9.00942 22.4583 17.4998 22.4583C25.9903 22.4583 34.5832 19.8173 34.5832 14.7708V7.9375C34.5832 2.89108 25.9903 0.25 17.4998 0.25ZM3.83317 14.7708V12.726C4.91513 13.3387 6.06082 13.8313 7.24984 14.1951V17.4085C5.0085 16.5304 3.83317 15.4849 3.83317 14.7708ZM24.3332 15.0237V18.3908C22.852 18.6966 21.1437 18.9204 19.2082 19.0024V15.5857C20.9275 15.5173 22.6399 15.3295 24.3332 15.0237ZM15.7915 19.0041C14.0695 18.9381 12.3556 18.7336 10.6665 18.3925V15.0254C12.3048 15.3226 14.0353 15.5157 15.7915 15.5891V19.0041ZM27.7498 17.4085V14.1951C28.9391 13.8321 30.0849 13.3394 31.1665 12.726V14.7708C31.1665 15.4849 29.9929 16.5304 27.7498 17.4085ZM17.4998 12.2083C8.6558 12.2083 3.83317 9.38788 3.83317 7.9375C3.83317 6.48713 8.6558 3.66667 17.4998 3.66667C26.3439 3.66667 31.1665 6.48713 31.1665 7.9375C31.1665 9.38788 26.3439 12.2083 17.4998 12.2083Z", fill: theme.colors[color] })));
};

var Icon$r = function (props) {
    var theme = useTheme();
    var color = props.color ? props.color : "primary";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 62 62", fill: "none" }, props),
        React.createElement("path", { d: "M27.1243 56.8333C13.5704 56.8333 2.58268 45.2673 2.58268 31C2.58268 16.7326 13.5704 5.16663 27.1243 5.16663C40.6783 5.16663 51.666 16.7326 51.666 31C51.666 45.2673 40.6783 56.8333 27.1243 56.8333Z", stroke: theme.colors[color], fill: "none", "stroke-width": "4" }),
        React.createElement("path", { d: "M33.583 22.7333C31.9388 21.4 29.8873 20.6706 27.7705 20.6666C22.4204 20.6666 18.083 25.2908 18.083 31C18.083 36.7091 22.4204 41.3333 27.7705 41.3333C29.9508 41.3333 31.9633 40.5635 33.583 39.2666", stroke: theme.colors[color], fill: "none", "stroke-width": "4" }),
        React.createElement("path", { d: "M25.833 5.16663C37.0266 5.16663 59.4163 7.74996 59.4163 31C59.4163 54.25 37.0266 56.8333 25.833 56.8333", fill: "none", stroke: theme.colors[color], "stroke-width": "4" })));
};
...
var Icon$v = function (props) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24", fill: "none" }, props),
        React.createElement("circle", { cx: "12", cy: "12", r: "8", fill: theme.colors[color] })));
};
...
var Icon$A = function (props) {
    ...
    var color = props.color ? props.color : "primary";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("g", { clipPath: "url(#clip0_2821_47354)" },
            React.createElement("path", { d: "M17.722 12.1687L12.5004 15.4313L7.27539 12.1687L12.5004 3L17.722 12.1687ZM12.5004 16.4789L7.27539 13.2164L12.5004 21L17.7254 13.2164L12.5004 16.4789V16.4789Z", fill: theme.colors[color] })),
        React.createElement("defs", null,
            React.createElement("clipPath", { id: "clip0_2821_47354" },
                React.createElement("rect", { width: "11", height: "18", fill: "white", transform: "translate(7 3)" })))));
};

var Icon$B = function (props) {
    var theme = useTheme();
    var color = props.color ? props.color : "primary";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64", stroke: theme.colors[color] }, props),
        React.createElement("path", { d: "M18.6667 26.6667H56L45.3333 16M45.3333 37.3333H8L18.6667 48", "stroke-width": "5", "stroke-linecap": "round", "stroke-linejoin": "round", fill: "none" })));
};

var Icon$C = function (props) {
    var theme = useTheme();
    var color = props.color ? props.color : "primary";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 14 14", fill: "none" }, props),
        React.createElement("path", { d: "M12.75 12.0625H1.25C0.973437 12.0625 0.75 12.2859 0.75 12.5625V13.125C0.75 13.1938 0.80625 13.25 0.875 13.25H13.125C13.1938 13.25 13.25 13.1938 13.25 13.125V12.5625C13.25 12.2859 13.0266 12.0625 12.75 12.0625ZM3.02656 10.75C3.05781 10.75 3.08906 10.7469 3.12031 10.7422L5.74844 10.2812C5.77969 10.275 5.80938 10.2609 5.83125 10.2375L12.4547 3.61406C12.4692 3.59961 12.4807 3.58244 12.4885 3.56354C12.4963 3.54463 12.5004 3.52437 12.5004 3.50391C12.5004 3.48344 12.4963 3.46318 12.4885 3.44428C12.4807 3.42538 12.4692 3.40821 12.4547 3.39375L9.85781 0.795313C9.82812 0.765625 9.78906 0.75 9.74687 0.75C9.70469 0.75 9.66563 0.765625 9.63594 0.795313L3.0125 7.41875C2.98906 7.44219 2.975 7.47031 2.96875 7.50156L2.50781 10.1297C2.49261 10.2134 2.49804 10.2995 2.52364 10.3807C2.54923 10.4618 2.59421 10.5355 2.65469 10.5953C2.75781 10.6953 2.8875 10.75 3.02656 10.75Z", fill: theme.colors[color] })));
};

var Icon$D = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 16 16" }, props),
        React.createElement("path", { d: "M15.36 0H0.64C0.286 0 0 0.286 0 0.64V15.36C0 15.714 0.286 16 0.64 16H15.36C15.714 16 16 15.714 16 15.36V0.64C16 0.286 15.714 0 15.36 0ZM13.512 4.67H12.234C11.232 4.67 11.038 5.146 11.038 5.846V7.388H13.43L13.118 9.802H11.038V16H8.544V9.804H6.458V7.388H8.544V5.608C8.544 3.542 9.806 2.416 11.65 2.416C12.534 2.416 13.292 2.482 13.514 2.512V4.67H13.512Z" })));
};

var Icon$E = function (props) {
    var theme = useTheme();
    var color = props.color ? props.color : "primary";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 16 13", fill: "none" }, props),
        React.createElement("path", { d: "M7 12.5C7 12.5 6 12.5 6 11.5C6 10.5 7 7.5 11 7.5C15 7.5 16 10.5 16 11.5C16 12.5 15 12.5 15 12.5H7ZM11 6.5C11.7956 6.5 12.5587 6.18393 13.1213 5.62132C13.6839 5.05871 14 4.29565 14 3.5C14 2.70435 13.6839 1.94129 13.1213 1.37868C12.5587 0.816071 11.7956 0.5 11 0.5C10.2044 0.5 9.44129 0.816071 8.87868 1.37868C8.31607 1.94129 8 2.70435 8 3.5C8 4.29565 8.31607 5.05871 8.87868 5.62132C9.44129 6.18393 10.2044 6.5 11 6.5Z", fill: theme.colors[color] }),
        React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M5.216 12.4999C5.06776 12.1878 4.99382 11.8455 5 11.4999C5 10.1449 5.68 8.74994 6.936 7.77994C6.30909 7.58677 5.65595 7.49231 5 7.49994C1 7.49994 0 10.4999 0 11.4999C0 12.4999 1 12.4999 1 12.4999H5.216Z", fill: theme.colors[color] }),
        React.createElement("path", { d: "M4.5 6.5C5.16304 6.5 5.79893 6.23661 6.26777 5.76777C6.73661 5.29893 7 4.66304 7 4C7 3.33696 6.73661 2.70107 6.26777 2.23223C5.79893 1.76339 5.16304 1.5 4.5 1.5C3.83696 1.5 3.20107 1.76339 2.73223 2.23223C2.26339 2.70107 2 3.33696 2 4C2 4.66304 2.26339 5.29893 2.73223 5.76777C3.20107 6.23661 3.83696 6.5 4.5 6.5Z", fill: theme.colors[color] })));
};

var Icon$F = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "M20.0297 6.76406L14.9859 1.72031C14.8453 1.57969 14.6555 1.5 14.4562 1.5H4.5C4.08516 1.5 3.75 1.83516 3.75 2.25V21.75C3.75 22.1648 4.08516 22.5 4.5 22.5H19.5C19.9148 22.5 20.25 22.1648 20.25 21.75V7.29609C20.25 7.09687 20.1703 6.90469 20.0297 6.76406ZM18.5203 7.64062H14.1094V3.22969L18.5203 7.64062ZM18.5625 20.8125H5.4375V3.1875H12.5156V8.25C12.5156 8.51107 12.6193 8.76145 12.8039 8.94606C12.9885 9.13066 13.2389 9.23438 13.5 9.23438H18.5625V20.8125ZM11.8125 14.4844H7.5C7.39687 14.4844 7.3125 14.5688 7.3125 14.6719V15.7969C7.3125 15.9 7.39687 15.9844 7.5 15.9844H11.8125C11.9156 15.9844 12 15.9 12 15.7969V14.6719C12 14.5688 11.9156 14.4844 11.8125 14.4844ZM7.3125 11.4844V12.6094C7.3125 12.7125 7.39687 12.7969 7.5 12.7969H16.5C16.6031 12.7969 16.6875 12.7125 16.6875 12.6094V11.4844C16.6875 11.3813 16.6031 11.2969 16.5 11.2969H7.5C7.39687 11.2969 7.3125 11.3813 7.3125 11.4844Z" })));
};

var Icon$G = function (props) {
    var theme = useTheme();
    var color = props.color ? props.color : "primary";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20 18", fill: "none" }, props),
        React.createElement("path", { d: "M6.17966 16.6406C6.17966 17.0555 6.51247 17.3906 6.92497 17.3906H13.075C13.4875 17.3906 13.8203 17.0555 13.8203 16.6406V12.0469H6.17966V16.6406ZM18.6273 0.609375H1.37263C0.798409 0.609375 0.439815 1.23516 0.728096 1.73438L5.91482 10.5469H14.0898L19.2765 1.73438C19.5601 1.23516 19.2015 0.609375 18.6273 0.609375Z", fill: theme.colors[color] })));
};

var Icon$H = function (props) {
    var theme = useTheme();
    var color = props.color ? props.color : "primary";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 55 54", fill: "none" }, props),
        React.createElement("path", { d: "M39.333 0.166687C32.203 0.166687 26.4163 5.95335 26.4163 13.0834C26.4163 20.2134 32.203 26 39.333 26C46.463 26 52.2497 20.2134 52.2497 13.0834C52.2497 5.95335 46.463 0.166687 39.333 0.166687ZM39.333 20.8334C35.0447 20.8334 31.583 17.3717 31.583 13.0834C31.583 8.79502 35.0447 5.33335 39.333 5.33335C43.6213 5.33335 47.083 8.79502 47.083 13.0834C47.083 17.3717 43.6213 20.8334 39.333 20.8334ZM47.083 36.3334H41.9163C41.9163 33.2334 39.9788 30.4434 37.0855 29.3584L21.1722 23.4167H0.583008V51.8334H16.083V48.1133L34.1663 53.125L54.833 46.6667V44.0834C54.833 39.795 51.3713 36.3334 47.083 36.3334ZM10.9163 46.6667H5.74967V28.5834H10.9163V46.6667ZM34.0888 47.7259L16.083 42.7917V28.5834H20.2422L35.2772 34.1892C36.1555 34.525 36.7497 35.3775 36.7497 36.3334C36.7497 36.3334 31.583 36.2042 30.808 35.9459L24.6597 33.905L23.0322 38.8134L29.1805 40.8542C30.498 41.2934 31.8672 41.5 33.2622 41.5H47.083C48.0905 41.5 48.9947 42.12 49.408 42.9725L34.0888 47.7259Z", stroke: theme.colors[color] })));
};
...
var Icon$J = function (props) {
    var theme = useTheme();
    var color = props.color ? props.color : "primary";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64", fill: "none" }, props),
        React.createElement("path", { d: "M50.6667 8H13.3333C10.392 8 8 10.392 8 13.3333V50.6667C8 53.608 10.392 56 13.3333 56H50.6667C53.608 56 56 53.608 56 50.6667V13.3333C56 10.392 53.608 8 50.6667 8ZM13.3333 50.6667V13.3333H50.6667L50.672 50.6667H13.3333Z", fill: theme.colors[color] }),
        React.createElement("path", { d: "M26.6667 37.3337L24 34.667L16 45.3337H48L34.6667 26.667L26.6667 37.3337Z", fill: theme.colors[color] })));
};

var Icon$K = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 74 74" }, props),
        React.createElement("path", { d: "M27.75 40.0833L37 27.75L46.25 41.625V37H58.5833V15.4167C58.5833 12.0157 55.8175 9.25 52.4166 9.25H12.3333C8.93238 9.25 6.16663 12.0157 6.16663 15.4167V52.4167C6.16663 55.8176 8.93238 58.5833 12.3333 58.5833H37V46.25H15.4166L24.6666 33.9167L27.75 40.0833Z" }),
        React.createElement("path", { d: "M58.5834 43.1667H52.4167V52.4167H43.1667V58.5834H52.4167V67.8334H58.5834V58.5834H67.8334V52.4167H58.5834V43.1667Z" })));
};
...
var Icon$N = function (props) {
    var theme = useTheme();
    var color = props.color ? props.color : "primary";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 16 20", fill: "none" }, props),
        React.createElement("path", { d: "M16 10C16 8.897 15.103 8 14 8H13V5C13 2.243 10.757 0 8 0C5.243 0 3 2.243 3 5V8H2C0.897 8 0 8.897 0 10V18C0 19.103 0.897 20 2 20H14C15.103 20 16 19.103 16 18V10ZM5 5C5 3.346 6.346 2 8 2C9.654 2 11 3.346 11 5V8H5V5Z", fill: theme.colors[color] })));
};

var Icon$O = function (props) {
    return (React.createElement(Svg, __assign({ width: '57px', height: '57px' }, props),
...
var Icon$P = function (props) {
    return (React.createElement(Svg, __assign({ width: '100%', height: '60px' }, props),
...
var Icon$R = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24", fill: "none" }, props),
        React.createElement("path", { d: "M8.00877 3.94531L1.91895 9.99148L12.0686 20.0757L22.2183 9.99148L16.1285 3.94531H8.00877Z", fill: "#2DE370" }),
        React.createElement("path", { d: "M7.72496 7.87399C10.126 5.47299 14.0112 5.47299 16.3904 7.87399L18.464 9.94759L16.3904 12.0212C13.9894 14.4222 10.1041 14.4222 7.72496 12.0212L5.65137 9.94759L7.72496 7.87399Z", fill: "black" }),
        React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M12.0691 12.4798C10.6721 12.4798 9.53711 11.3667 9.53711 10.0134C9.53711 8.66007 10.6721 7.54688 12.0691 7.54688C13.466 7.54688 14.601 8.66007 14.601 10.0134C14.601 11.3667 13.466 12.4798 12.0691 12.4798Z", fill: "white" }),
        React.createElement("path", { d: "M12.0686 11.017C11.4792 11.017 10.999 10.5368 10.999 9.94747C10.999 9.35813 11.4792 8.87793 12.0686 8.87793C12.6579 8.87793 13.1381 9.35813 13.1381 9.94747C13.1163 10.5368 12.6579 11.017 12.0686 11.017Z", fill: "black" })));
};
...
var Icon$V = function (props) {
    return (React.createElement(Svg, __assign({ width: '80%' }, props),
...
var Icon$14 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24", fill: "none" }, props),
        React.createElement("path", { d: "M6.53669 2.96094H17.384C19.3802 2.96094 20.9998 4.58056 20.9998 6.57673V17.4241C20.9998 19.4203 19.3802 21.0399 17.384 21.0399H6.53669C4.54052 21.0399 2.9209 19.4203 2.9209 17.4241V6.57673C2.9209 4.58056 4.54052 2.96094 6.53669 2.96094Z", fill: "#FEDA08" }),
        React.createElement("path", { d: "M15.3952 11.9356C15.9649 11.7884 16.4718 11.3612 16.4718 10.5043C16.4718 9.07775 15.2601 8.74707 13.7104 8.74707H7.53125V15.1676H10.1309V12.988H13.2156C13.6911 12.988 13.9687 13.1763 13.9687 13.6421V15.1652H16.5707V13.5601C16.5707 12.6887 16.0783 12.136 15.3952 11.9356ZM13.2615 11.2574H10.1309V10.6298H13.2615C13.6018 10.6298 13.8094 10.6757 13.8094 10.9436C13.8094 11.2115 13.6018 11.2574 13.2615 11.2574Z", fill: "#010101" })));
};

var Icon$15 = function (props) {
    var theme = useTheme();
    var color = props.color ? props.color : "primary";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 52 52", fill: "none" }, props),
        React.createElement("path", { d: "M9.65055 5.99725C19.7979 -2.3185 34.7941 -1.73984 44.2672 7.73325C54.3551 17.8212 54.3551 34.1788 44.2672 44.2667C34.1793 54.3547 17.8216 54.3547 7.73371 44.2667C4.63793 41.1752 2.37866 37.3475 1.16807 33.1432C-0.0425227 28.9389 -0.164716 24.4959 0.812963 20.2314L1.01188 19.4228L6.00805 20.7403C4.76945 25.4478 5.23226 30.4415 7.3149 34.8412C9.39754 39.2409 12.9663 42.7642 17.3924 44.7903C21.8184 46.8164 26.8175 47.2152 31.5088 45.9164C36.2 44.6176 40.2823 41.7045 43.0361 37.6907C45.7899 33.6768 47.0385 28.8197 46.5618 23.9753C46.0852 19.131 43.9139 14.6104 40.4306 11.2102C36.9473 7.80995 32.3756 5.74838 27.5212 5.38878C22.6668 5.02918 17.8412 6.39464 13.895 9.2445L13.324 9.67333L15.9513 12.3006L4.0783 15.0389L6.81663 3.16591L9.64796 5.99725H9.65055ZM28.5838 10.5V15.6667H35.0421V20.8333H20.8338C20.511 20.8327 20.1997 20.953 19.9612 21.1705C19.7227 21.3879 19.5742 21.6868 19.545 22.0083C19.5159 22.3297 19.6081 22.6505 19.8036 22.9073C19.9991 23.1642 20.2837 23.3385 20.6013 23.396L20.8338 23.4167H31.1671C32.88 23.4167 34.5227 24.0971 35.7339 25.3083C36.945 26.5194 37.6255 28.1621 37.6255 29.875C37.6255 31.5879 36.945 33.2306 35.7339 34.4417C34.5227 35.6529 32.88 36.3333 31.1671 36.3333H28.5838V41.5H23.4171V36.3333H16.9588V31.1667H31.1671C31.4899 31.1673 31.8012 31.047 32.0397 30.8295C32.2783 30.6121 32.4267 30.3132 32.4559 29.9917C32.4851 29.6702 32.3928 29.3495 32.1973 29.0927C32.0018 28.8358 31.7172 28.6615 31.3996 28.604L31.1671 28.5833H20.8338C19.1209 28.5833 17.4782 27.9029 16.2671 26.6917C15.0559 25.4806 14.3755 23.8379 14.3755 22.125C14.3755 20.4121 15.0559 18.7694 16.2671 17.5583C17.4782 16.3471 19.1209 15.6667 20.8338 15.6667H23.4171V10.5H28.5838Z", fill: theme.colors[color] })));
};

var Icon$16 = function (props) {
    var theme = useTheme();
    var color = props.color ? props.color : "primary";
    return (React.createElement(Svg, __assign({ viewBox: "0 0 56 42", fill: "none" }, props),
        React.createElement("path", { d: "M7.33398 6.79167C7.33398 6.79167 15.084 19.7083 28.0007 19.7083C40.9173 19.7083 48.6673 6.79167 48.6673 6.79167", stroke: theme.colors[color], "stroke-width": "4", fill: "none" }),
        React.createElement("path", { d: "M7.33398 2.91667V39.0833", stroke: theme.colors[color], "stroke-width": "4", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React.createElement("path", { d: "M48.667 2.91667V39.0833", stroke: theme.colors[color], "stroke-width": "4", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React.createElement("path", { d: "M2.16699 29.3958C2.16699 29.3958 17.9094 28.6242 28.0003 28.75C38.1006 28.8759 53.8337 30.0417 53.8337 30.0417", stroke: theme.colors[color], "stroke-width": "4", "stroke-linecap": "round" }),
        React.createElement("path", { d: "M17.667 17.125V28.75", stroke: theme.colors[color], "stroke-width": "4", "stroke-linecap": "round" }),
        React.createElement("path", { d: "M28 19.7083V28.75", stroke: theme.colors[color], "stroke-width": "4", "stroke-linecap": "round" }),
        React.createElement("path", { d: "M38.334 17.125V28.75", stroke: theme.colors[color], "stroke-width": "4", "stroke-linecap": "round" }),
        React.createElement("path", { d: "M7.33366 6.79167L2.16699 13.25", stroke: theme.colors[color], "stroke-width": "4", "stroke-linecap": "round" }),
        React.createElement("path", { d: "M53.8337 13.25L48.667 6.79167", stroke: theme.colors[color], "stroke-width": "4", "stroke-linecap": "round" })));
};
...
var Icon$1m = function (props) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 18 18", fill: "none" }, props),
        React.createElement("path", { d: "M13.2344 3.46119e-05C10.6094 0.0105815 8.5 2.44339 8.5 5.39651V7.87502H1.5C0.671875 7.87502 0 8.63088 0 9.56252V16.3125C0 17.2441 0.671875 18 1.5 18H12.5C13.3281 18 14 17.2441 14 16.3125V9.56252C14 8.63088 13.3281 7.87502 12.5 7.87502H11V5.37541C11 3.98323 11.9906 2.82659 13.2281 2.81253C14.4781 2.79847 15.5 3.94104 15.5 5.34377V8.15627C15.5 8.62385 15.8344 9.00002 16.25 9.00002H17.25C17.6656 9.00002 18 8.62385 18 8.15627V5.34377C18 2.39066 15.8594 -0.0105122 13.2344 3.46119e-05Z", fill: theme.colors[color] })));
};

var Icon$1n = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "M11 15H13V9H16L12 4L8 9H11V15Z" }),
        React.createElement("path", { d: "M20 18H4V11H2V18C2 19.103 2.897 20 4 20H20C21.103 20 22 19.103 22 18V11H20V18Z" })));
};
...
var ButtonMenuWrapper = styled(Box)(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  display: flex;\n  justify-content: center;\n  width: 100%;\n  > div {\n    @media (max-width: 600px) {\n      margin: 4px, 4px;\n      padding: 4px;\n      overflow: auto;\n      white-space: nowrap;\n    }\n\n    &::-webkit-scrollbar {\n      display: none;\n    }\n\n    -ms-overflow-style: none; /* IE and Edge */\n    scrollbar-width: none; /* Firefox */\n  }\n"], ["\n  display: flex;\n  justify-content: center;\n  width: 100%;\n  > div {\n    @media (max-width: 600px) {\n      margin: 4px, 4px;\n      padding: 4px;\n      overflow: auto;\n      white-space: nowrap;\n    }\n\n    &::-webkit-scrollbar {\n      display: none;\n    }\n\n    -ms-overflow-style: none; /* IE and Edge */\n    scrollbar-width: none; /* Firefox */\n  }\n"])));
...
var ButtonMenu = function (_a) {
    ...
    return (React.createElement(ButtonMenuWrapper, null,
        React.createElement(StyledButtonMenu, { variant: variant }, Children.map(children, function (child, index) {
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ forwardedAs: as, variant: "tertiary", colorKey: variant === variants.AWESOME ? "sidebarColor" : "textSubtle" }, props)));
    }
...
var BarChartLoader = function (props) {
    return (React.createElement(Svg, __assign({ width: "100%", height: "100%", viewBox: "0 0 50 25", preserveAspectRatio: "none", opacity: "0.1" }, props),
        React.createElement("rect", { width: "8%", fill: "#1FC7D4" },
            React.createElement("animate", { attributeName: "height", dur: "0.9s", values: "15%; 90%; 15%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.9s" }),
            React.createElement("animate", { attributeName: "y", dur: "0.9s", values: "85%; 10%; 85%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.9s" })),
        React.createElement("rect", { x: "10.222%", width: "8%", fill: "#1FC7D4" },
            React.createElement("animate", { attributeName: "height", dur: "0.9s", values: "15%; 90%; 15%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.8s" }),
            React.createElement("animate", { attributeName: "y", dur: "0.9s", values: "85%; 10%; 85%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.8s" })),
        React.createElement("rect", { x: "20.444%", width: "8%", fill: "#1FC7D4" },
            React.createElement("animate", { attributeName: "height", dur: "0.9s", values: "15%; 90%; 15%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.7s" }),
            React.createElement("animate", { attributeName: "y", dur: "0.9s", values: "85%; 10%; 85%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.7s" })),
        React.createElement("rect", { x: "30.666%", width: "8%", fill: "#1FC7D4" },
            React.createElement("animate", { attributeName: "height", dur: "0.9s", values: "15%; 90%; 15%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.6s" }),
            React.createElement("animate", { attributeName: "y", dur: "0.9s", values: "85%; 10%; 85%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.6s" })),
        React.createElement("rect", { x: "40.888%", width: "8%", fill: "#1FC7D4" },
            React.createElement("animate", { attributeName: "height", dur: "0.9s", values: "15%; 90%; 15%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.5s" }),
            React.createElement("animate", { attributeName: "y", dur: "0.9s", values: "85%; 10%; 85%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.5s" })),
        React.createElement("rect", { x: "51.11%", width: "8%", fill: "#1FC7D4" },
            React.createElement("animate", { attributeName: "height", dur: "0.9s", values: "15%; 90%; 15%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.4s" }),
            React.createElement("animate", { attributeName: "y", dur: "0.9s", values: "85%; 10%; 85%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.4s" })),
        React.createElement("rect", { x: "61.332%", width: "8%", fill: "#1FC7D4" },
            React.createElement("animate", { attributeName: "height", dur: "0.9s", values: "15%; 90%; 15%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.3s" }),
            React.createElement("animate", { attributeName: "y", dur: "0.9s", values: "85%; 10%; 85%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.3s" })),
        React.createElement("rect", { x: "71.554%", width: "8%", fill: "#1FC7D4" },
            React.createElement("animate", { attributeName: "height", dur: "0.9s", values: "15%; 90%; 15%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.2s" }),
            React.createElement("animate", { attributeName: "y", dur: "0.9s", values: "85%; 10%; 85%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.2s" })),
        React.createElement("rect", { x: "81.776%", width: "8%", fill: "#1FC7D4" },
            React.createElement("animate", { attributeName: "height", dur: "0.9s", values: "15%; 90%; 15%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.1s" }),
            React.createElement("animate", { attributeName: "y", dur: "0.9s", values: "85%; 10%; 85%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite", begin: "-0.1s" })),
        React.createElement("rect", { x: "91.998%", width: "8%", fill: "#1FC7D4" },
            React.createElement("animate", { attributeName: "height", dur: "0.9s", values: "15%; 90%; 15%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "y", dur: "0.9s", values: "85%; 10%; 85%", keyTimes: "0; 0.55; 1", repeatCount: "indefinite" }))));
};

var CandleChartLoader = function (props) {
    return (React.createElement(Svg, __assign({ width: "100%", height: "100%", viewBox: "0 0 100 50", opacity: "0.1" }, props),
        React.createElement("rect", { width: "5%", fill: "#31D0AA" },
            React.createElement("animate", { attributeName: "height", dur: "2s", values: "0%; 40%; 40%; 10%; 10%", keyTimes: "0; 0.125; 0.5; 0.625; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "y", dur: "2s", from: "50%", to: "30%", values: "30%; 10%; 10%; 25%; 25%", keyTimes: "0; 0.125; 0.5; 0.625; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "rx", dur: "2s", values: "0%; 0%; 100%; 100%;", keyTimes: "0; 0.6; 0.625; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "x", dur: "2s", values: "32.5%; 32.5%; 47.5%; 47.5%;", keyTimes: "0; 0.7; 0.8; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "opacity", dur: "2s", values: "1; 1; 0; 0;", keyTimes: "0; 0.75; 0.9; 1", repeatCount: "indefinite" })),
        React.createElement("rect", { width: "5%", fill: "#31D0AA" },
            React.createElement("animate", { attributeName: "height", dur: "2s", values: "0%; 0%; 20%; 20%; 10%; 10%", keyTimes: "0; 0.125; 0.25; 0.5; 0.625; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "y", dur: "2s", values: "15%; 15%; 5%; 5%; 25%; 25%", keyTimes: "0; 0.125; 0.25; 0.5; 0.625; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "rx", dur: "2s", values: "0%; 0%; 100%; 100%;", keyTimes: "0; 0.6; 0.625; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "x", dur: "2s", values: "42.5%; 42.5%; 47.5%; 47.5%;", keyTimes: "0; 0.7; 0.8; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "opacity", dur: "2s", values: "1; 1; 0; 0;", keyTimes: "0; 0.75; 0.9; 1", repeatCount: "indefinite" })),
        React.createElement("rect", { width: "5%", fill: "#ED4B9E" },
            React.createElement("animate", { attributeName: "height", dur: "2s", values: "0%; 0%; 35%; 35%; 10%; 10%", keyTimes: "0; 0.25; 0.375; 0.5; 0.625; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "y", dur: "2s", values: "25%; 25%; 10%; 10%; 25%; 25%", keyTimes: "0; 0.25; 0.375; 0.5; 0.625; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "rx", dur: "2s", values: "0%; 0%; 100%; 100%;", keyTimes: "0; 0.6; 0.625; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "x", dur: "2s", values: "52.5%; 52.5%; 47.5%; 47.5%;", keyTimes: "0; 0.7; 0.8; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "opacity", dur: "2s", values: "1; 1; 0; 0;", keyTimes: "0; 0.75; 0.9; 1", repeatCount: "indefinite" })),
        React.createElement("rect", { width: "5%", fill: "#31D0AA" },
            React.createElement("animate", { attributeName: "height", dur: "2s", values: "0%; 0%; 35%; 35%; 10%; 10%", keyTimes: "0; 0.375; 0.5; 0.5; 0.625; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "y", dur: "2s", values: "15%; 15%; 0%; 0%; 25%; 25%", keyTimes: "0; 0.375; 0.5; 0.5; 0.625; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "rx", dur: "2s", values: "0%; 0%; 100%; 100%;", keyTimes: "0; 0.6; 0.625; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "x", dur: "2s", values: "62.5%; 62.5%; 47.5%; 47.5%;", keyTimes: "0; 0.7; 0.8; 1", repeatCount: "indefinite" }),
            React.createElement("animate", { attributeName: "opacity", dur: "2s", values: "1; 1; 0; 0;", keyTimes: "0; 0.75; 0.9; 1", repeatCount: "indefinite" }))));
};

var LineChartLoader = function (props) {
    return (React.createElement(Svg, __assign({ width: "100%", height: "100%", preserveAspectRatio: "none", viewBox: "0 0 100 50" }, props),
        React.createElement("path", { d: "M 0 49 C 1 49 1 45 4 47 C 7 49 7 35 11 37 C 13 38 14 32 16 34 C 18 35.6667 20 40 22 39 C 24 38 24 34 26 34 C 27 34 29 39 32 36 C 33 35 34 32 35 32 C 37 32 37 35 39 34 C 40 33 39 29 43 31 C 46 32 45 28 47 30 C 50 32 49 22 51 24 Q 53 26 55 24 C 56 23 56 25 57 26 C 58 27 59 28 60 28 C 63 28 66 17 67 16 C 68 15 69 17 70 16 C 71 15 71 13 74 13 C 76 13 76 14 77 15 C 79 17 80 18 82 18 C 83 18 83 17 84 17 C 87 17 89 24 91 24 C 93 24 95 20 96 17 C 97.6667 13.3333 98 9 101 6", stroke: "#2BA55D", strokeWidth: "0.2", strokeDasharray: "156", strokeDashoffset: "156", fill: "transparent", opacity: "0.5", filter: "url(#glow)" },
            React.createElement("animate", { id: "firstline", attributeName: "stroke-dashoffset", dur: "2s", from: "156", to: "-156", begin: "0s;firstline.end+0.5s" })),
        React.createElement("path", { d: "M 0 49 C 1 49 1 45 4 47 C 7 49 7 35 11 37 C 13 38 14 32 16 34 C 18 35.6667 20 40 22 39 C 24 38 24 34 26 34 C 27 34 29 39 32 36 C 33 35 34 32 35 32 C 37 32 37 35 39 34 C 40 33 39 29 43 31 C 46 32 45 28 47 30 C 50 32 49 22 51 24 Q 53 26 55 24 C 56 23 56 25 57 26 C 58 27 59 28 60 28 C 63 28 66 17 67 16 C 68 15 69 17 70 16 C 71 15 71 13 74 13 C 76 13 76 14 77 15 C 79 17 80 18 82 18 C 83 18 83 17 84 17 C 87 17 89 24 91 24 C 93 24 95 20 96 17 C 97.6667 13.3333 98 9 101 6", stroke: "#2BA55D", strokeWidth: "0.2", strokeDasharray: "156", strokeDashoffset: "156", fill: "transparent", opacity: "0.5", filter: "url(#glow)" },
            React.createElement("animate", { id: "secondline", attributeName: "stroke-dashoffset", dur: "2s", from: "156", to: "-156", begin: "1.3s;secondline.end+0.5s" })),
        React.createElement("defs", null,
            React.createElement("filter", { id: "glow" },
                React.createElement("feGaussianBlur", { className: "blur", result: "coloredBlur", stdDeviation: "4" }),
...
var CustomBar = function (_a) {
    ...
    return (React.createElement("g", null,
        React.createElement("rect", { x: x, y: y, fill: fill, width: width, height: height, rx: "2" })));
};
...
var Chart = function (_a) {
    ...
    if (!data || data.length === 0) {
        return React.createElement(BarChartLoader, null);
    }
    return (React.createElement(ResponsiveContainer, { width: "100%", height: "100%" },
        React.createElement(BarChart, { data: data, margin: {
                top: 5,
                right: 15,
                left: 0,
                bottom: 5,
            ...
            React.createElement(XAxis, { dataKey: "time", axisLine: false, tickLine: false, tickFormatter: function (time) {
                    return time.toLocaleDateString(undefined, { day: "2-digit" });
                }, minTickGap: 10 }),
            React.createElement(YAxis, { dataKey: "value", tickCount: 6, scale: "linear", axisLine: false, tickLine: false, color: theme.colors.textSubtle, fontSize: "12px", tickFormatter: function (val) { return "$" + formatAmount(val); }, orientation: "right", tick: { dx: 10, fill: theme.colors.textSubtle } }),
            React.createElement(Tooltip$1, { cursor: { fill: theme.colors.textSubtle }, contentStyle: { display: "none" }, formatter: function (tooltipValue, name, props) { return (React.createElement(HoverUpdater, { locale: getLocale(), payload: props.payload, setHoverValue: setHoverValue, setHoverDate: setHoverDate })); } }),
            React.createElement(Bar$1, { dataKey: "value", fill: theme.colors.primary, shape: function (props) { return (React.createElement(CustomBar, { height: props.height, width: props.width, x: props.x, y: props.y, fill: theme.colors.primary })); } }))));
};
...
var CandleChart = function (_a) {
    ...
    var _b = useState(), chartCreated = _b[0], setChart = _b[1];
    ...
    return (React.createElement(React.Fragment, null,
        !chartCreated && React.createElement(CandleChartLoader, null),
        React.createElement("div", __assign({ ref: chartRef, id: "candle-chart" }, rest))));
};
...
var pulse = keyframes(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n  0% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.4;\n  }\n  100% {\n    opacity: 1;\n  }\n"], ["\n  0% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.4;\n  }\n  100% {\n    opacity: 1;\n  }\n"])));
...
var Wrapper = styled(Flex)(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["\n  overflow-x: scroll;\n  padding: 0;\n  border-radius: 24px 24px 0 0;\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  scrollbar-width: none; /* Firefox */\n"], ["\n  overflow-x: scroll;\n  padding: 0;\n  border-radius: 24px 24px 0 0;\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  scrollbar-width: none; /* Firefox */\n"])));
var Inner = styled(Flex)(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  justify-content: space-between;\n  background-color: ", ";\n  width: 100%;\n"], ["\n  justify-content: space-between;\n  background-color: ", ";\n  width: 100%;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.card.background;
});
var TabToggle = styled.button(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  display: inline-flex;\n  justify-content: center;\n  cursor: pointer;\n  flex: 1;\n  border: 0;\n  outline: 0;\n  padding: 16px;\n  margin: 0;\n  border-radius: 24px 24px 0 0;\n  font-size: 16px;\n  font-weight: 600;\n  color: ", ";\n  background-color: ", ";\n"], ["\n  display: inline-flex;\n  justify-content: center;\n  cursor: pointer;\n  flex: 1;\n  border: 0;\n  outline: 0;\n  padding: 16px;\n  margin: 0;\n  border-radius: 24px 24px 0 0;\n  font-size: 16px;\n  font-weight: 600;\n  color: ",
    ";\n  background-color: ",
    ";\n"])), function (_a) {
...
var LineChart = function (_a) {
    ...
    var theme = useTheme();
    if (!data || data.length === 0) {
        return React.createElement(LineChartLoader, null);
    }
    return (React.createElement(ResponsiveContainer, null,
        React.createElement(AreaChart, { data: data, width: 300, height: 308, margin: {
                top: 5,
                right: 15,
                left: 0,
                bottom: 5,
            ...
            React.createElement("defs", null,
                React.createElement("linearGradient", { id: "gradient", x1: "0", y1: "0", x2: "0", y2: "1" },
                    React.createElement("stop", { offset: "5%", stopColor: theme.colors.inputSecondary, stopOpacity: 0.5 }),
                    React.createElement("stop", { offset: "100%", stopColor: theme.colors.primary, stopOpacity: 0 }))),
            React.createElement(XAxis, { dataKey: "time", axisLine: false, tickLine: false, tickFormatter: function (time) {
                    return time.toLocaleDateString(undefined, { day: "2-digit" });
                }, minTickGap: 10 }),
            React.createElement(YAxis, { dataKey: "value", tickCount: 6, scale: "linear", axisLine: false, tickLine: false, fontSize: "12px", tickFormatter: function (val) { return "$" + formatAmount(val); }, orientation: "right", tick: { dx: 10, fill: theme.colors.textSubtle } }),
            React.createElement(Tooltip$1, { cursor: { stroke: theme.colors.primary }, contentStyle: { display: "none" }, formatter: function (tooltipValue, name, props) { return (React.createElement(HoverUpdater$1, { locale: getLocale(), payload: props.payload, setHoverValue: setHoverValue, setHoverDate: setHoverDate })); } }),
            React.createElement(Area, { dataKey: "value", type: "monotone", stroke: theme.colors.primary, fill: "url(#gradient)", strokeWidth: 2 }))));
};
...
var ChartCard = function (_a) {
    ...
    var _b = useState(ChartView.VOLUME), view = _b[0], setView = _b[1];
    var _c = useState(), hoverValue = _c[0], setHoverValue = _c[1];
    var _d = useState(), hoverDate = _d[0], setHoverDate = _d[1];
    var currentDate = new Date().toLocaleString(getLocale(), {
        month: "short",
        year: "numeric",
        day: "numeric",
    });
    var formattedTvlData = useMemo(function () {
        if (chartData) {
    ...
    var formattedVolumeData = useMemo(function () {
        if (chartData) {
            return chartData.map(function (day) {
                return {
                    time: fromUnixTime(day.date),
    ...
    var getLatestValueDisplay = function () {
        ...
        return valueToDisplay ? (React.createElement(Text, { fontSize: "24px", bold: true },
            "$",
            valueToDisplay)) : (React.createElement(Skeleton, { height: "36px", width: "128px" }));
    };
    return (React.createElement(Card, null,
        React.createElement(TabToggleGroup, null,
            React.createElement(TabToggle, { isActive: view === ChartView.VOLUME, onClick: function () { return setView(ChartView.VOLUME); } },
                React.createElement(Text, { color: view === ChartView.VOLUME ? "primary" : "white", bold: view === ChartView.VOLUME }, "Volume")),
            React.createElement(TabToggle, { isActive: view === ChartView.LIQUIDITY, onClick: function () { return setView(ChartView.LIQUIDITY); } },
                React.createElement(Text, { color: view === ChartView.LIQUIDITY ? "primary" : "white", bold: view === ChartView.LIQUIDITY }, "Liquidity")),
            variant === "token" ? (React.createElement(TabToggle, { isActive: view === ChartView.PRICE, onClick: function () { return setView(ChartView.PRICE); } },
                React.createElement(Text, { color: view === ChartView.PRICE ? "primary" : "white", bold: view === ChartView.PRICE }, "Price"))) : (React.createElement(React.Fragment, null))),
        React.createElement(Flex, { flexDirection: "column", px: "24px", pt: "24px" },
            getLatestValueDisplay(),
            React.createElement(Text, { small: true, color: "white" }, hoverDate || currentDate)),
        React.createElement(Box, { px: "24px", height: variant === "token" ? "250px" : "335px" }, view === ChartView.LIQUIDITY ? (React.createElement(LineChart, { data: formattedTvlData, setHoverValue: setHoverValue, setHoverDate: setHoverDate })) : view === ChartView.VOLUME ? (React.createElement(Chart, { data: formattedVolumeData, setHoverValue: setHoverValue, setHoverDate: setHoverDate })) : view === ChartView.PRICE ? (React.createElement(CandleChart, { data: tokenPriceData !== null && tokenPriceData !== void 0 ? tokenPriceData : [], setValue: setHoverValue, setLabel: setHoverDate })) : null)));
};
...
var Container = styled.div(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"], ["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"])), DropdownContent, DropdownContent);
...
var Bunny = styled.div(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n  display: inline-flex;\n  position: fixed;\n  top: 0;\n  left: ", ";\n  transform: translate3d(0, -100%, 0);\n  user-select: none;\n  pointer-events: none;\n  z-index: 99999;\n\n  animation-name: ", ";\n  animation-duration: ", ";\n  animation-timing-function: linear;\n  animation-iteration-count: ", ";\n  animation-play-state: running;\n\n  &:nth-child(5n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 2) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(2n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 10) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(7n + 2) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(4n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 7) {\n    animation-delay: ", ";\n  }\n"], ["\n  display: inline-flex;\n  position: fixed;\n  top: 0;\n  left: ", ";\n  transform: translate3d(0, -100%, 0);\n  user-select: none;\n  pointer-events: none;\n  z-index: 99999;\n\n  animation-name: ", ";\n  animation-duration: ", ";\n  animation-timing-function: linear;\n  animation-iteration-count: ", ";\n  animation-play-state: running;\n\n  &:nth-child(5n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 2) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(2n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 10) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(7n + 2) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(4n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 7) {\n    animation-delay: ", ";\n  }\n"])), function (_a) {
    var position = _a.position;
    return position + "vw";
...
var Placeholder = styled.div(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n"])));
...
var SelectWrapper = styled(Box)(templateObject_1$v || (templateObject_1$v = __makeTemplateObject(["\n  position: relative;\n  z-index: 1;\n  height: fit-content;\n  width: auto;\n"], ["\n  position: relative;\n  z-index: 1;\n  height: fit-content;\n  width: auto;\n"])));
var Select = styled.select(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  background-color: ", ";\n  border: 0;\n  border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  display: block;\n  font-size: 16px;\n  height: ", ";\n  outline: 0;\n  padding: 0 16px;\n  width: 100%;\n  padding-right: 40px;\n  padding-left: ", ";\n\n  text-overflow: ellipsis;\n  white-space: nowrap;\n\n  -moz-appearance: none; /* Firefox */\n  -webkit-appearance: none; /* Safari and Chrome */\n  appearance: none;\n\n  &::-webkit-inner-spin-button {\n    -webkit-appearance: none;\n    margin: 0;\n  }\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    background-color: ", ";\n    box-shadow: none;\n    color: ", ";\n    cursor: not-allowed;\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: ", ";\n  }\n"], ["\n  background-color: ", ";\n  border: 0;\n  border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  display: block;\n  font-size: 16px;\n  height: ", ";\n  outline: 0;\n  padding: 0 16px;\n  width: 100%;\n  padding-right: 40px;\n  padding-left: ", ";\n\n  text-overflow: ellipsis;\n  white-space: nowrap;\n\n  -moz-appearance: none; /* Firefox */\n  -webkit-appearance: none; /* Safari and Chrome */\n  appearance: none;\n\n  &::-webkit-inner-spin-button {\n    -webkit-appearance: none;\n    margin: 0;\n  }\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    background-color: ", ";\n    box-shadow: none;\n    color: ", ";\n    cursor: not-allowed;\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
...
var StyledChevronDownIcon = styled(Icon$j)(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  width: ", ";\n  position: absolute;\n  right: 16px;\n  top: 50%;\n  transform: translateY(-50%);\n  pointer-events: none;\n"], ["\n  width: ", ";\n  position: absolute;\n  right: 16px;\n  top: 50%;\n  transform: translateY(-50%);\n  pointer-events: none;\n"])), getIconSize);
var StartIconWrapper = styled.div(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: absolute;\n  left: 16px;\n  top: 50%;\n  transform: translateY(-50%);\n  pointer-events: none;\n"], ["\n  position: absolute;\n  left: 16px;\n  top: 50%;\n  transform: translateY(-50%);\n  pointer-events: none;\n"])));
var getStartIcon = function (startIcon) {
    var isValid = isValidElement(startIcon);
    if (isValid) {
        return React.createElement(StartIconWrapper, null, startIcon);
    }
    return null;
};
function SelectComponent(_a) {
    ...
    return (React.createElement(SelectWrapper, __assign({}, props, { onChange: onChange }),
        startIcon && getStartIcon(startIcon),
        React.createElement(Select, { scale: scale, isSuccess: isSuccess, isWarning: isWarning, startIcon: startIcon, onChange: function (e) { return onValueChanged(e.target.value); } }, options.map(function (option) {
            return (React.createElement("option", { selected: selected === option.value, key: option.value, value: option.value }, option.label));
        })),
        React.createElement(StyledChevronDownIcon, { scale: scale || scales$4.MD })));
}
...
var Container$1 = styled.div(templateObject_3$5 || (templateObject_3$5 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var RotatingPancakeIcon = styled(Icon$1u)(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate$1);
var FloatingPanIcon = styled(Icon$1t)(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var TextArea = styled.textarea(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  background-color: ", ";\n  border: 0;\n  border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  display: block;\n  font-size: 16px;\n  height: 95px;\n  outline: 0;\n  padding: 6px 16px;\n  width: 100%;\n  \n  &::-webkit-inner-spin-button {\n    -webkit-appearance: none;\n    margin: 0;\n  }\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    background-color: ", ";\n    box-shadow: none;\n    color: ", ";\n    cursor: not-allowed;\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: ", ";\n  }\n"], ["\n  background-color: ", ";\n  border: 0;\n  border-radius: 16px;\n  box-shadow: ", ";\n  color: ", ";\n  display: block;\n  font-size: 16px;\n  height: 95px;\n  outline: 0;\n  padding: 6px 16px;\n  width: 100%;\n  \n  &::-webkit-inner-spin-button {\n    -webkit-appearance: none;\n    margin: 0;\n  }\n\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    background-color: ", ";\n    box-shadow: none;\n    color: ", ";\n    cursor: not-allowed;\n  }\n\n  &:focus:not(:disabled) {\n    box-shadow: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
...
var StyledNavTab = styled(Box)(templateObject_1$A || (templateObject_1$A = __makeTemplateObject(["\n  align-items: center;\n  display: flex;\n  list-style-type: none;\n  width: 100%;\n  overflow: auto;\n\n  -ms-overflow-style: none;  /* IE and Edge */\n  scrollbar-width: none;  /* Firefox */\n  &::-webkit-scrollbar {\n    display: none;\n  }\n\n  ", ";\n"], ["\n  align-items: center;\n  display: flex;\n  list-style-type: none;\n  width: 100%;\n  overflow: auto;\n\n  -ms-overflow-style: none;  /* IE and Edge */\n  scrollbar-width: none;  /* Firefox */\n  &::-webkit-scrollbar {\n    display: none;\n  }\n\n  ", ";\n"])), space);
var ChildTab = styled.li(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  min-width: max-content;\n  cursor: pointer;\n  margin-left: ", ";\n  margin-right: 12px;\n  padding-bottom: 5px;\n  border-bottom: 5px solid\n    ", ";\n  > div {\n    color: ", ";\n    font-weight: ", ";\n  }\n  ", " {\n    margin-left: ", ";\n    margin-right: 16px;\n  }\n"], ["\n  min-width: max-content;\n  cursor: pointer;\n  margin-left: ", ";\n  margin-right: 12px;\n  padding-bottom: 5px;\n  border-bottom: 5px solid\n    ",
    ";\n  > div {\n    color: ", ";\n    font-weight: ", ";\n  }\n  ", " {\n    margin-left: ", ";\n    margin-right: 16px;\n  }\n"])), function (_a) {
    var index = _a.index;
...
var NavTab = function (_a) {
    ...
    return (React.createElement(StyledNavTab, null, validItems.map(function (item, index) { return (React.createElement(ChildTab, { onClick: onItemClick ? function () { return onItemClick(index); } : undefined, isActive: activeIndex === index ? true : false, index: index, key: "child-" + index }, item)); })));
};
...
var Modal = function (_a) {
    ...
    return (React.createElement(StyledModal, null,
        showWalletBack && React.createElement(WalletBack, null),
        React.createElement(ModalHeader, null,
            React.createElement(ModalTitle, null,
                onBack && (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React.createElement(Icon$5, { color: "sidebarColor" }))),
                React.createElement(Heading, { color: 'sidebarColor', fontSize: '26px', fontWeight: '800' }, title)),
            !hideCloseButton && (React.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog", style: { justifyContent: 'flex-end' } },
                React.createElement(Icon$o, { color: 'sidebarColor', width: '24px', height: '24px', cursor: 'pointer' })))),
        !hideSeparator &&
...
var WalletCard = function (_a) {
    ...
    return (React.createElement(Flex, { width: "100%", height: '40px', borderBottom: '1px solid #0d1b24', onClick: function () {
        ...
        React.createElement(Text, { fontSize: '16px', fontWeight: '600', color: "sidebarColor", mr: "16px" }, title),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", bodyPadding: "0 30px 30px 30px", hideSeparator: true, showWalletBack: true, onDismiss: onDismiss },
        walletsToShow.map(function (entry, index) { return (React.createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); }),
        React.createElement(HelpLink, { href: "https://t.me/kodakingofdogaltschat", external: true },
            React.createElement(Icon$I, { color: "sidebarColor", fontSize: "16px", mr: "6px" }),
...
var PanelHeader = function (_a) {
    ...
    return (React.createElement(StyledContainer, null,
        ...
        showConnectButton && (React.createElement(Flex, { justifyContent: "center" }, account ? (React.createElement(Button, { scale: "sm", variant: "tertiary", onClick: function () {
...
var Icon$1D = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 16 16", fill: "none" }, props),
        ...
        React.createElement("path", { d: "M9.7781 14H7.11144C6.99356 14 6.88052 14.0468 6.79717 14.1302C6.71382 14.2135 6.66699 14.3266 6.66699 14.4444C6.66699 14.5623 6.71382 14.6754 6.79717 14.7587C6.88052 14.8421 6.99356 14.8889 7.11144 14.8889H9.7781C9.89598 14.8889 10.009 14.8421 10.0924 14.7587C10.1757 14.6754 10.2225 14.5623 10.2225 14.4444C10.2225 14.3266 10.1757 14.2135 10.0924 14.1302C10.009 14.0468 9.89598 14 9.7781 14Z" }),
        React.createElement("path", { d: "M14.5333 14H11.4222C11.3044 14 11.1913 14.0468 11.108 14.1302C11.0246 14.2135 10.9778 14.3266 10.9778 14.4444C10.9778 14.5623 11.0246 14.6754 11.108 14.7587C11.1913 14.8421 11.3044 14.8889 11.4222 14.8889H14.5333C14.6512 14.8889 14.7643 14.8421 14.8476 14.7587C14.931 14.6754 14.9778 14.5623 14.9778 14.4444C14.9778 14.3266 14.931 14.2135 14.8476 14.1302C14.7643 14.0468 14.6512 14 14.5333 14Z" }),
...
var Icon$1U = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { fill: 'rgb(0,212,164)', d: "M6 10C4.9 10 4 10.9 4 12C4 13.1 4.9 14 6 14C7.1 14 8 13.1 8 12C8 10.9 7.1 10 6 10ZM18 10C16.9 10 16 10.9 16 12C16 13.1 16.9 14 18 14C19.1 14 20 13.1 20 12C20 10.9 19.1 10 18 10ZM12 10C10.9 10 10 10.9 10 12C10 13.1 10.9 14 12 14C13.1 14 14 13.1 14 12C14 10.9 13.1 10 12 10Z" })));
};
...
var Icon$27 = function (props) {
    return (React.createElement(Svg, __assign({ fill: "none", width: "24", height: "24", viewBox: "0 0 24 24" }, props),
        React.createElement("path", { fill: "none", d: "M13.5429 23.2501C8.14621 23.2501 3.77142 18.2133 3.77142 12.0001C3.77142 5.78689 8.14621 0.750092 13.5429 0.750092C18.9395 0.750092 23.3143 5.78689 23.3143 12.0001C23.3143 18.2133 18.9395 23.2501 13.5429 23.2501Z", stroke: "#00D5A5", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React.createElement("path", { fill: "none", d: "M16.1143 8.40008C15.4596 7.8195 14.6428 7.5018 13.8 7.50008C11.6698 7.50008 9.94286 9.51383 9.94286 12.0001C9.94286 14.4863 11.6698 16.5001 13.8 16.5001C14.6681 16.5001 15.4694 16.1648 16.1143 15.6001", stroke: "#00D5A5", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React.createElement("path", { fill: "none", d: "M14.0571 0.750092C9.60033 0.750092 0.685699 1.87509 0.685699 12.0001C0.685699 22.1251 9.60033 23.2501 14.0571 23.2501", stroke: "#00D5A5", "stroke-width": "2" })));
};

var Icon$28 = function (props) {
    return (React.createElement(Svg, __assign({ fill: "none", width: "24", height: "24", viewBox: "0 0 24 24" }, props),
        React.createElement("path", { fill: "none", d: "M5.17241 1.68758L1.75862 5.81258V20.2501C1.75862 20.7971 1.9984 21.3217 2.42521 21.7085C2.85201 22.0953 3.43089 22.3126 4.03448 22.3126H19.9655C20.5691 22.3126 21.148 22.0953 21.5748 21.7085C22.0016 21.3217 22.2414 20.7971 22.2414 20.2501V5.81258L18.8276 1.68758H5.17241Z", stroke: "#00D5A5", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React.createElement("path", { fill: "none", d: "M1.75862 5.81258H22.2414", stroke: "#00D5A5", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }),
        React.createElement("path", { fill: "none", d: "M16.5517 9.93757C16.5517 11.0316 16.0722 12.0808 15.2185 12.8544C14.3649 13.628 13.2072 14.0626 12 14.0626C10.7928 14.0626 9.63507 13.628 8.78147 12.8544C7.92783 12.0808 7.44827 11.0316 7.44827 9.93757", stroke: "#00D5A5", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" })));
};

var Icon$29 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24", fill: "none" }, props),
        React.createElement("g", { clipPath: "url(#clip0_401_119)" },
            React.createElement("path", { d: "M11.9993 0C5.38219 0 0 5.38355 0 11.9993C0 18.6151 3.95454 23.0405 9.40322 23.0405C10.8295 23.0405 11.5854 22.4461 11.6818 21.8952C11.7876 21.2899 11.2 20.6629 10.1822 20.2952C8.89703 19.8297 8.09364 18.8526 7.97693 17.6136C7.84936 16.2443 8.59983 14.7908 9.80628 14.0797C10.9476 13.4039 12.3006 13.4908 13.5152 14.3159C16.7735 16.5306 20.1296 17.2974 22.0648 16.2728C23.3486 15.5915 24 14.1557 24 12.002C24 5.38355 18.6165 0.00135708 11.9993 0.00135708V0ZM6.06751 8.66497C4.76472 8.66497 3.70483 7.60509 3.70483 6.30365C3.70483 5.00221 4.76336 3.94097 6.06751 3.94097C7.37167 3.94097 8.43019 4.99949 8.43019 6.30365C8.43019 7.6078 7.37031 8.66497 6.06751 8.66497V8.66497ZM11.717 6.30772C10.4142 6.30772 9.35437 5.24919 9.35437 3.94504C9.35437 2.64088 10.4129 1.58372 11.717 1.58372C13.0212 1.58372 14.0797 2.6436 14.0797 3.94504C14.0797 5.24648 13.0198 6.30772 11.717 6.30772ZM14.8994 6.21544C14.8994 4.91264 15.9579 3.85411 17.2621 3.85411C18.5662 3.85411 19.6234 4.91264 19.6234 6.21544C19.6234 7.51824 18.5649 8.57676 17.2621 8.57676C15.9593 8.57676 14.8994 7.51824 14.8994 6.21544V6.21544ZM20.1133 13.8802C18.8105 13.8802 17.7506 12.8204 17.7506 11.5176C17.7506 10.2148 18.8092 9.15488 20.1133 9.15488C21.4175 9.15488 22.4746 10.2148 22.4746 11.5176C22.4746 12.8204 21.4161 13.8802 20.1133 13.8802Z", fill: "#0FD6A9" })),
        React.createElement("defs", null,
            React.createElement("clipPath", { id: "clip0_401_119" },
...
var LangSelector = function (_a) {
    ...
    return (React.createElement(Dropdown, { position: "top-right", target: React.createElement(Button, { variant: "text", startIcon: React.createElement(LanguageIcon, { color: "sidebarColor", width: "24px" }) },
            React.createElement(Text, { color: "sidebarColor" }, currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase())) }, langs.map(function (lang) { return (React.createElement(MenuButton, { key: lang.code, fullWidth: true, onClick: function () { return setLang(lang); }, 
        // Safari fix
...
var CashState = function (_a) {
    ...
    return (React.createElement(StyledContainer$1, null,
        token == 'KODA' && React.createElement(KodaLogoIcon, null),
        token == 'KAPEX' && React.createElement(KapexLogoIcon, null),
        coinPriceUsd ? (React.createElement(Box, null, "$" + coinPriceUsd.toFixed(8))) : (React.createElement(Skeleton, { width: 100, height: 24 }))));
};
var KodaLogoIcon = styled.div(templateObject_1$M || (templateObject_1$M = __makeTemplateObject(["\n    width: 32px;\n    height: 32px;\n    background: url(https://raw.githubusercontent.com/Koda-Finance/summitswap-data/main/images/coins/koda.png);\n    background-size: 100% 100%;\n    margin: 6px 0px;\n    margin-right: 4px;\n"], ["\n    width: 32px;\n    height: 32px;\n    background: url(https://raw.githubusercontent.com/Koda-Finance/summitswap-data/main/images/coins/koda.png);\n    background-size: 100% 100%;\n    margin: 6px 0px;\n    margin-right: 4px;\n"])));
var KapexLogoIcon = styled.div(templateObject_2$h || (templateObject_2$h = __makeTemplateObject(["\n    width: 32px;\n    height: 32px;\n    background: url(https://raw.githubusercontent.com/Koda-Finance/summitswap-data/main/images/coins/kapex.png);\n    background-size: 100% 100%;\n    margin: 6px 0px;\n    margin-right: 4px;\n"], ["\n    width: 32px;\n    height: 32px;\n    background: url(https://raw.githubusercontent.com/Koda-Finance/summitswap-data/main/images/coins/kapex.png);\n    background-size: 100% 100%;\n    margin: 6px 0px;\n    margin-right: 4px;\n"])));
var StyledContainer$1 = styled.div(templateObject_3$9 || (templateObject_3$9 = __makeTemplateObject(["\n    display: flex;\n    align-items: center;\n    >div:nth-of-type(2) {\n        font-weight: 700;\n        font-size: 18px;\n        color: ", ";\n    }\n"], ["\n    display: flex;\n    align-items: center;\n    >div:nth-of-type(2) {\n        font-weight: 700;\n        font-size: 18px;\n        color: ", ";\n    }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.sidebarColor;
});
var templateObject_1$M, templateObject_2$h, templateObject_3$9;

var Container$4 = styled.div(templateObject_1$N || (templateObject_1$N = __makeTemplateObject(["\n  position: absolute;\n  bottom: 40px;\n  z-index: 3;\n  flex: 1.3;\n  padding: 35px 10px 0 30px;\n  background-color: transparent;\n"], ["\n  position: absolute;\n  bottom: 40px;\n  z-index: 3;\n  flex: 1.3;\n  padding: 35px 10px 0 30px;\n  background-color: transparent;\n"])));
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SettingsEntry, null,
            React.createElement(CashState, { coinPriceUsd: kodaPriceUsd, token: "KODA" }),
            React.createElement(CashState, { coinPriceUsd: kapexPriceUsd, token: "KAPEX" }),
        ...
        React.createElement(SocialEntry, null,
            ...
            React.createElement("a", { href: "https://t.me/kodakingofdogaltschat" },
                React.createElement(Icon$1_, null)),
            ...
            React.createElement("a", { href: "https://twitter.com/CoinKoda" },
                React.createElement(Icon$22, null)),
...
var StyledPanel = styled.div(templateObject_1$O || (templateObject_1$O = __makeTemplateObject(["\n  position: fixed;\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: 0px;\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ", ";\n  z-index: 11;\n  overflow: hidden;\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    width: ", "px;\n    overflow: unset;\n  }\n"], ["\n  position: fixed;\n  top: 0;\n  left: 0;\n  display: flex;\n  flex-direction: column;\n  flex-shrink: 0;\n  background-color: ", ";\n  width: 0px;\n  height: 100vh;\n  transition: padding-top 0.2s, width 0.2s;\n  border-right: ",
    ";\n  z-index: 11;\n  overflow: hidden;\n  transform: translate3d(0, 0, 0);\n\n  ", " {\n    width: ", "px;\n    overflow: unset;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.sidebarBackground;
}, function (_a) {
...
var Panel = function (props) {
    ...
    return (React.createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        ...
        React.createElement(PanelHeader, { account: account, login: login, logout: logout, showConnectButton: showConnectButton }),
        ...
        React.createElement(StyledNav, { showMenu: showMenu, open: open },
            React.createElement(Flex, { minWidth: "85%", justifyContent: "space-between", alignItems: "center" },
                ...
                React.createElement(ConnectAction, { justifyContent: "flex-end", alignItems: "center" },
                    ...
                    !open ? (React.createElement(Icon$1J, { ml: "5px", width: "35px", height: "40px", color: "sidebarColor", cursor: "pointer", onClick: function () { return setOpen(true); } })) : (React.createElement(Icon$o, { ml: "5px", width: "35px", height: "40px", color: "sidebarColor", cursor: "pointer", onClick: function () { return setOpen(false); } })))),
            React.createElement(SettingSocial, { mt: "10px", minWidth: "85%", flexDirection: "column", justifyContent: "space-between", alignItems: "center" },
                React.createElement(SettingsEntry$1, null,
                    React.createElement(CashState, { coinPriceUsd: kodaPriceUsd, token: "KODA" }),
                    React.createElement(CashState, { coinPriceUsd: kapexPriceUsd, token: "KAPEX" }),
                    currentLang && (langs === null || langs === void 0 ? void 0 : langs.length) && setLang ? (React.createElement(LangSelector$1, { currentLang: currentLang, langs: langs, setLang: setLang })) : null),
                React.createElement(SocialEntry$1, null,
                    ...
                    React.createElement("a", { href: "https://www.instagram.com/kodacryptocurrency" },
                        React.createElement(Icon$1O, null)))),
            React.createElement(EntryScroll, { minWidth: "85%", padding: "20px 0px" }, links.map(function (entry) {
                ...
                if (entry.items) {
                    ...
                    var initialOpenState = entry.initialOpenState === true
                        ? entry.initialOpenState
                        : itemsMatchIndex >= 0;
                    return (React.createElement(Accordion$1, { key: entry.label, isPushed: true, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }) }, entry.items.map(function (item) { return (React.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: function () { return setOpen(false); } },
                        React.createElement(MenuLink, { href: item.href }, item.label))); })));
                }
...
var BodyWrapper = styled.div(templateObject_2$m || (templateObject_2$m = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n"], ["\n  position: relative;\n  display: flex;\n"])));
var Inner$1 = styled.div(templateObject_3$d || (templateObject_3$d = __makeTemplateObject(["\n  flex-grow: 1;\n  // margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  max-width: 100%;\n\n  ", " {\n    margin-left: ", "px;\n    max-width: calc(100% - ", "px);\n  }\n"], ["\n  flex-grow: 1;\n  // margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  max-width: 100%;\n\n  ", " {\n    margin-left: ", "px;\n    max-width: calc(100% - ", "px);\n  }\n"])), function (_a) {
...
styled(Overlay)(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"], ["\n  position: fixed;\n  height: 100%;\n\n  ", " {\n    display: none;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
...
var alertTypeMap = (_a$3 = {},
    ...
    _a$3);
var StyledToast = styled.div(templateObject_1$S || (templateObject_1$S = __makeTemplateObject(["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"], ["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
...
var StyledToastContainer = styled.div(templateObject_1$T || (templateObject_1$T = __makeTemplateObject(["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"], ["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"])));
...
export { Icon$4 as AddIcon, Alert, Icon$5 as ArrowBackIcon, Icon$6 as ArrowDownIcon, Icon$7 as ArrowDropDownIcon, Icon$8 as ArrowDropUpIcon, Icon$9 as ArrowForwardIcon, Icon$a as AutoRenewIcon, BackgroundImage, Chart as BarChart, BarChartLoader, GridLayout as BaseLayout, Icon$b as BinanceIcon, Icon$2 as BlockIcon, Icon$c as BoldVIcon, Box, Breadcrumbs, Icon$d as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$f as CalculateIcon, Icon$g as CalendarIcon, CandleChart, CandleChartLoader, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$e as CardViewIcon, GridLayout$1 as CardsLayout, ChartCard, Checkbox, Icon$h as ChecklistIcon, Icon as CheckmarkCircleIcon, Icon$i as CheckmarkIcon, Icon$j as ChevronDownIcon, Icon$k as ChevronLeftIcon, Icon$l as ChevronRightIcon, Icon$m as ChevronUpIcon, Icon$v as CircleFilledIcon, Icon$n as ClockIcon, Icon$o as CloseIcon, Icon$p as CogIcon, Icon$r as Coin2Icon, Icon$s as CoinBagIcon, Icon$q as CoinIcon, Icon$t as CommunityIcon, ConnectorNames, Icon$u as CopyIcon, Icon$w as DetailIcon, Icon$x as DiscordIcon, Icon$y as DownloadIcon, Dropdown, Icon$C as EditIcon, Icon$z as EmailIcon, Icon$1 as ErrorIcon, Icon$A as EtherIcon, Icon$B as ExchangeIcon, Icon$D as FacebookIcon, FallingBunnies, Icon$E as FewPeopleIcon, Icon$F as FileIcon, Icon$G as FilterIcon, Flex, Icon$H as HandCoinIcon, Heading, Icon$I as HelpIcon, IconButton, Image, Icon$K as ImageAddIcon, Icon$J as ImageIcon, Icon$3 as InfoIcon, Input, Icon$L as LaunchpadIcon, LineChart, LineChartLoader, Link, LinkExternal, Icon$M as ListViewIcon, Icon$N as LockIcon, Icon$O as LogoIcon, Icon$Q as LogoRoundIcon, Icon$P as LogoTextIcon, Icon$R as LooksRareIcon, Menu, Icon$S as MetamaskIcon, Icon$T as MinusIcon, Modal, ModalProvider, NavTab, Icon$U as NoProfileAvatarIcon, Icon$V as OmniIcon, Icon$W as OpenNewIcon, Icon$X as OpenSeaIcon, Icon$Z as PairCoinsIcon, Icon$_ as PancakeRoundIcon, Icon$Y as PancakesIcon, Icon$$ as PeopleIcon, Percent, Icon$10 as PrizeIcon, Progress, Icon$13 as ProgressBunny, Radio, Icon$14 as RaribleIcon, Icon$15 as RefundIcon, Icon$11 as RemoveIcon, ResetCSS, Icon$16 as RouterIcon, Icon$1e as SearchIcon, SelectComponent as Select, Icon$1f as ShareIcon, Icon$1g as ShopIcon, Skeleton, Icon$1h as SocialGroupIcon, Icon$1i as SortIcon, Spinner, Icon$1j as SpreadsheetIcon, Svg, Icon$1k as SwapVertIcon, Icon$1l as SyncAltIcon, TabToggle, TabToggleGroup, Tag, Icon$18 as TelegramIcon, Text, TextArea, Icon$19 as Ticket, Icon$1a as TicketRound, ToastContainer, Toggle, Icon$1d as TopLogoIcon, Icon$1b as TrashIcon, Icon$1c as TwitterIcon, Icon$1m as UnLockIcon, Icon$1n as UploadIcon, Icon$12 as VerifiedIcon, Icon$1o as VestingIcon, Icon$1p as WalletIcon, Icon$1q as WarningIcon, Icon$1r as WebIcon, Icon$17 as Won, Icon$1s as X2Y2Icon, variants$1 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
