...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      <div
        class="sc-bXDlPE fLMLRG"
      >
        <div
          class="sc-dlfnbm sc-hKgILt isWJdv AmOVA"
        >
          <nav
            class="sc-gsxnyZ kbFUZb"
          >
            <div
              class="sc-dlfnbm sc-hKgILt lkQHhn gPTDCk"
            >
              <div
                class="sc-kIeTtH iBipsJ"
              >
                <a
                  href="/"
                >
                  <div
                    class="sc-bTvRPi kgJDbk"
                  />
                </a>
              </div>
              <div
                class="sc-dlfnbm sc-hKgILt sc-GTWni isWJdv jszezi cGftZI"
              >
                <div>
                  <button
            ...
            <div
              class="sc-dlfnbm sc-hKgILt sc-dtwoBo kvYdsH clYVkQ bzGPwh"
            >
              <div
                class="sc-fvhGYg hWGwXb"
              />
            </div>
            <div
              class="sc-dlfnbm sc-jQbIHB iaMnCl faRhZb"
            >
              <div
        ...
        <div
          class="sc-eGCarw cylOOr"
        >
          <div
            class="sc-jONnTn gunTvi"
          >
            <div
              class="sc-hlTvYk giZsIU"
            />
            <div
